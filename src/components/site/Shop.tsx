    ...
    <section className="relative py-20">
      <div className="mx-auto max-w-7xl px-4">
        <div className="text-center mb-10">
          <p className="text-xs tracking-[0.4em] uppercase text-royal-glow mb-3">— Workshop</p>
          <h2 className="text-4xl sm:text-5xl font-bold text-gradient-silver font-nepali">{t("sections.shopTitle")}</h2>
        </div>
